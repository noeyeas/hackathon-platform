...
const FAQ = [
  ...
  {
    q: "어떤 주제로 개발하나요?",
    a: "월계1동 지역사회 문제를 해결하는 웹·애플리케이션을 만듭니다. 상권 활성화, 탄소중립 및 ESG, 청년·지역 상생, 배리어프리 및 생활 편의, 기타 — 5개 분야 중에서 정하면 됩니다. 특정 주제로 신청이 쏠릴 경우 주제당 최대 10팀으로 제한될 수 있습니다.",
  },
  {
    q: "무엇을 제출해야 하나요?",
  ...
  {
    q: "순위는 어떻게 정해지나요?",
    a: "두 단계로 나뉩니다. 먼저 10.9 최종발표에서 심사위원 평가와 참가 팀 간 상호 평가(2:1)를 합산해 상위 10~15팀을 전시 진출팀으로 선정합니다. 이어서 10.11–10.13 전시 기간에 전시 진출팀을 대상으로 주민투표를 진행합니다 — 전시장에서 투표권(QR)을 받아 휴대폰으로 마음에 든 팀에 투표하시면 됩니다. 최종 순위는 심사점수에 주민투표 점수를 합산해 정합니다. 합산 점수 1위 팀이 노원구청장상을 받고 2~4위 3팀이 광운대학교 총장상을 받습니다. 공정성을 위해 실시간 순위·점수는 대회가 끝난 뒤에 공개됩니다.",
  },
];
  ...
  return (
    <div className="flex flex-col gap-24">
      ...
      <Section eyebrow="Theme" title="해커톤 주제" desc="월계1동을 비롯한 지역사회의 생활 밀착형 문제 해결을 위한 웹·애플리케이션 개발">
        ...
        {/* 주제 쏠림 고지 — 카드 바로 아래에 둬야 주제를 고르는 시점에 읽힌다. */}
        <Reveal>
          <p className="text-xs leading-relaxed text-[var(--muted)]">
            · 특정 주제로 신청이 쏠릴 경우 <b className="text-ink">주제당 최대 10팀</b>으로
            제한될 수 있습니다.
          </p>
        </Reveal>
      </Section>
      ...
      <Section
        eyebrow="Awards"
        title="시상 및 심사"
        desc="최종발표 심사로 전시 진출 10~15팀을 선정하고, 전시 기간 주민투표로 최종 수상팀을 가립니다."
      >
          ...
          <div className="card">
            ...
            <ol className="mb-5 flex flex-col gap-2 text-sm text-[var(--muted)]">
              <li>
                ...
                <b className="text-ink">상위 10~15팀</b>을 전시 진출팀으로 선정
              </li>
              <li>
              ...
              <li>
                수상팀에는 상금과 별도로{" "}
                <b className="text-ink">서버 운영비 등 후속 지원</b>이 제공될
                예정입니다
              </li>
              <li>
                참가자에게는 <b className="text-ink">출석인증서</b>가 발급됩니다
              </li>
            </ol>
