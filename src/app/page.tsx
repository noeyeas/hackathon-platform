...
const AWARDS = [
  ...
  { medal: "🥈", t: "광운대학교 총장상", n: "3팀", money: "각 50만원", d: "전시 진출팀 중 주민투표 2~4위" },
...
const FAQ = [
  ...
  {
    q: "순위는 어떻게 정해지나요?",
    a: "두 단계로 나뉩니다. 먼저 10.9 최종발표에서 심사위원 평가와 참가 팀 간 상호 평가(2:1)를 합산해 상위 10~15팀을 전시 진출팀으로 선정합니다. 이어서 10.11–10.13 전시 기간에 전시 진출팀을 대상으로 주민투표를 진행합니다 — 전시장에서 투표권(QR)을 받아 휴대폰으로 마음에 든 팀에 투표하시면 됩니다. 가장 많은 표를 받은 1팀이 노원구청장 표창을 받고 2~4위 3팀이 광운대학교 총장상을 받습니다. 공정성을 위해 실시간 순위·점수는 대회가 끝난 뒤에 공개됩니다.",
  },
];
